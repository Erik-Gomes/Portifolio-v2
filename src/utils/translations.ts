...
export const translations = {
    pt: {
        ...
        hero: {
            ...
            description:
                'Atualmente no 3º semestre de Análise e Desenvolvimento de Sistemas na Fatec Indaiatuba. Minha jornada começou com Arduino e C++, e hoje foco em construir aplicações modernas com Java (Spring Boot) e React.',
            btnCerts: 'Ver Certificados',
            btnGithub: 'GitHub',
        },
        about: {
            title: 'Sobre Mim',
            p1: 'Olá! Meu nome é Erik, tenho ' + myAge + ' anos e sou apaixonado por tecnologia desde que me lembro. Atualmente, estou no primeiro semestre da faculdade de Análise e Desenvolvimento de Sistemas (ADS), onde estou explorando ainda mais meu interesse em programação e desenvolvimento de software.',
    ...
    en: {
        ...
        hero: {
            ...
            description:
                'Currently in my 3rd semester of Systems Analysis and Development at Fatec Indaiatuba. My journey started with Arduino and C++, and today I focus on building modern applications with Java (Spring Boot) and React.',
            btnCerts: 'View Certificates',
            btnGithub: 'GitHub',
        },
        about: {
            title: 'About Me',
            p1: "Hello! My name is Erik, I'm " + myAge + " years old, and I've been passionate about technology for as long as I can remember. Currently, I'm in the first semester of college studying Analysis and Development of Systems (ADS), where I'm further exploring my interest in programming and software development.",
